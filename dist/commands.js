    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    promise_return = true;
                    return [4 /*yield*/, axios_1["default"].post("https://platypus.go.yj.fr/apiEC/moyenne/?periode=A003", qs_1["default"].stringify({
                            "username": "MarcJus",
                            "password": "Hen12goa"
                        }))
                            .then(function (value) {
                ...
                case 1:
                    _a.sent();
                    return [2 /*return*/, promise_return];
            }
        });
    });
}
